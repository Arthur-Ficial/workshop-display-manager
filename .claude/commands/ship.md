...
Read and follow `.claude/skills/shipping-and-launch/SKILL.md`.
...
Each call passes `subagent_type` matching the persona's `name` field. The personas are installed in `.claude/agents/`:
