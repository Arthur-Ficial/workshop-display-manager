...
public enum ManpageFormatter {
    public static func render() -> String {
        ...
        .TP
        .B wallpaper set <id|main> <path> [\\-\\-no\\-confirm|\\-\\-confirm]
        Set the desktop wallpaper of \\fI<id>\\fR to the file at
        \\fI<path>\\fR. Routes through SafeMutation: applies the new
        wallpaper, asks for confirmation, restores the previous URL on
        revert / timeout. Use \\fB\\-\\-no\\-confirm\\fR for unattended
        scripts.
        .TP
        .B save <name>
        ...
        .TP
        .B virtual create \\-\\-name <s> [\\-\\-mode WxH@Hz] [\\-\\-hidpi] [\\-\\-mirror-on <id>] [\\-\\-duration-ms N]
        ...
        .TP
        .B screenshot <id|main> \\-\\-out <path>
        Capture the framebuffer of the named display to a PNG. Wraps the
        ...
        works for real, virtual, and AirPlay displays.
        .TP
        .B sleep
